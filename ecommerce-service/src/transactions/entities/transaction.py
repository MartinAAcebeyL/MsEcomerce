...
class Transaction():
    ...
    def __init__(self, id, buyer_user, products, created_at=None, updated_at=None, deleted_at=None):
    ...
    def from_dict(cls, dict):
        ...
        return Transaction(id, buyer_user, products, created_at, updated_at, deleted_at)
